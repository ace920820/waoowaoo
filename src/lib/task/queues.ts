...
const IMAGE_TYPES = new Set<TaskType>([
  ...
  TASK_TYPE.REMAKE_KEYFRAME_IMAGE_GENERATE,
  TASK_TYPE.REMAKE_KEYFRAME_ACTION_SHEET,
...
const VIDEO_TYPES = new Set<TaskType>([TASK_TYPE.VIDEO_PANEL, TASK_TYPE.VIDEO_SHOT_GROUP, TASK_TYPE.LIP_SYNC, TASK_TYPE.REMAKE_VIDEO_GENERATE, TASK_TYPE.REMAKE_VIDEO_UNIT_GENERATE])
