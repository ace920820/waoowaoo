...
import { createPromptImageWorker } from './prompt-image.worker'

const workers = [createImageWorker(), createVideoWorker(), createVoiceWorker(), createTextWorker(), createPromptImageWorker()]
